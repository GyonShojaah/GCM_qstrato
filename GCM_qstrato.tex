...
\memoYF{Optical properties of clouds are computed based on the effective radius which is calculated within the model, assuming XXXX distribution for the water droplets particle size distribution and XXXX for the ice crystals. 
...
Cloud effective radius is diagnosed from the cloud water content assuming a specified number concentration for liquid clouds over ocean and land and for ice clouds. 
The effective radius is used with the condensed water path to diagnose the cloud optical thickness. }
