...
\memoYF{V}arious three-dimensional (3D) general circulation models (GCMs) revisited the atmospheric structure of terrestrial planets and have demonstrated the importance of accounting for the 3D circulation and climate heterogeneity \citep[e.g.][]{Ishiwatari2002,Abe2011,Leconte2013a,Leconte2013b,Wolf2014,Wolf2015}. 
%
\memoYF{In particular, planets in the habitable zones around late-type stars may be synchronously rotating due to tidal locking \citep{Dole1964, Kasting1993}, although this need not always occur \citep{Goldreich1966,Leconte2015}.
...
%
\memoYF{The details of the ROCKE-3D GCM are presented in \citet{Way2017}. 
Of these, the most important for our results are the radiation parameterization and the convection/cloud parameterizations.  We therefore discuss each of these in some detail below, followed by the description of other settings specific to our experiments in this paper. }
%
...
\subsubsection{Radiation Scheme of of \modelE{}}

\memoYF{The version of the model used here is the same as that used by \citet{Way2016}, except for the radiation scheme. The original ModelE2 radiation scheme } 
...
\memoYF{H$_2$O continuum absorption is treated using the CAVIAR continuum \citep{Ptashnik2011}.}
...
\subsubsection{Cloud Scheme of \modelE{}}

\memoYF{The \modelE{}  cumulus parameterization uses a mass flux closure determined by the mass required to establish neutral buoyancy at cloud base over a specified adjustment time. 
...
\memoYF{Detrained condensate is treated by the stratiform cloud microphysics \citep[an updated version of][]{DelGenio1996}. 
...
%
The third and fourth points above imply that the effects of clouds we find are the largest among the possible realizations \memoYF{given the particle size distribution, because of the non-linear dependence of transmittance on the optical thickness}. 
...
\memoYF{We also ran equivalent simulations for other types of stars and found that the overall responses to the ``transparent high clouds'' assumption are very similar.}
...
\memoYF{We find a quasi-exponential increase of \wv{} mixing ratios in the upper atmosphere as a function of total incident flux, resulting in a variation of several orders of magnitude as the total incident flux increases by a factor of two to three,  but more gradual than predicted by 1-D models. }
...
\memoYF{Although the enhanced abundance of \wv{} in the upper atmosphere has also been observed in 1D photochemical atmospheric models \citep{Rauer2011,Rugheimer2013,Rugheimer2015}, the mechanism that controls \wv{} is different because we did not include photochemistry. }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Validation of radiation scheme used in \memoYF{\modelE{}} }
\label{ap:radiation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
