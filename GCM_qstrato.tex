...
%This radiation scheme treats opacities using 
...
For short-wave radiation, we use 29 bands, as indicated by the grey vertical lines in Fig.~\ref{fig:star_spectra} and listed in Table \ref{tab:short-wave}, in order to ensure accuracy of the short-wave absorption. 
...
The spin effect is non-negligible, however; we find that \xwater{} becomes smaller as the spin period gets very short, i.e., increasing planet spin partly offsets the effect of increasing stellar flux.  %, most prominent at spin period smaller than 30 days. 
...
%
The super-rotating zonal wind seen in the equatorial region in the shorter period runs (not shown) efficiently transports water vapor from the dayside to the nightside, limiting the cloudiness in the substellar region, and 
